...
const CACHE = "agent-platform-v382";
const ASSETS = ["./manifest.json","./icon-192.png","./icon-512.png","./assets/malmatchum-presenter-poses.png","./assets/malmatchum-lounge-bgm-sfx.mp3"]; // HTML/sw는 캐시 목록에서 제외(항상 새로 받음)
